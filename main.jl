...
"""
	run(; p=EpiEconMFG.MFGEpiEcon(), F0=EpiEconMFG.create_test_distribution(p), show_progress=true, outdir=nothing, kwargs...)
...
"""
    run_dynamic(; p=EpiEconMFG.MFGEpiEcon(), F0=EpiEconMFG.create_test_distribution(p), show_progress=true, outdir=nothing, kwargs...)
